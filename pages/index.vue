<template>
  <div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div class="space-y-8">
            <h1 class="text-4xl sm:text-5xl font-bold text-gray-900 leading-tight">
              Eco-Friendly Rides for a <span class="text-green-600">Greener Tomorrow</span>
            </h1>
            <p class="text-xl text-gray-600">
              Choose sustainable transportation with GroenTaxi. Our eco-friendly fleet reduces carbon emissions while providing comfortable and reliable service.
            </p>
            <button class="bg-green-600 hover:bg-green-700 text-white px-8 py-4 rounded-lg text-lg font-semibold transition-colors">
              Book Now
            </button>
          </div>
      ...
      <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="bg-white p-6 rounded-lg shadow-sm">
            <h3 class="text-xl font-semibold mb-4">Airport Transfers</h3>
            <p class="text-gray-600">Reliable and punctual airport pickup and drop-off services.</p>
          </div>
          <div class="bg-white p-6 rounded-lg shadow-sm">
            <h3 class="text-xl font-semibold mb-4">City Rides</h3>
            <p class="text-gray-600">Comfortable transportation for your daily commute or city exploration.</p>
          </div>
          <div class="bg-white p-6 rounded-lg shadow-sm">
            <h3 class="text-xl font-semibold mb-4">Long Distance</h3>
            <p class="text-gray-600">Eco-friendly intercity travel with fixed competitive rates.</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section id="why-us" class="py-16">
      <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <h2 class="text-3xl font-bold text-center mb-12">Why Choose GroenTaxi</h2>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div class="text-center">
            ...
            <p class="text-gray-600">100% electric and hybrid vehicles</p>
          </div>
          <div class="text-center">
            <div class="w-16 h-16 mx-auto mb-4 bg-green-100 rounded-full flex items-center justify-center">
              <span class="text-2xl">💰</span>
            </div>
            <h3 class="text-lg font-semibold mb-2">Affordable</h3>
          ...
          <div class="text-center">
            ...
            <h3 class="text-lg font-semibold mb-2">Comfortable</h3>
            <p class="text-gray-600">Modern, well-maintained vehicles</p>
          </div>
          <div class="text-center">
            <div class="w-16 h-16 mx-auto mb-4 bg-green-100 rounded-full flex items-center justify-center">
            ...
            <p class="text-gray-600">Experienced, certified drivers</p>
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="max-w-3xl mx-auto bg-white rounded-lg shadow-sm p-8">
          <div class="space-y-6">
            <div class="flex justify-between items-center pb-4 border-b">
              <span class="font-semibold">Base Rate</span>
              <span>€2.50</span>
            </div>
            <div class="flex justify-between items-center pb-4 border-b">
              <span class="font-semibold">Per Kilometer</span>
              <span>€1.75</span>
            </div>
            <div class="flex justify-between items-center pb-4 border-b">
              <span class="font-semibold">Waiting Time (per minute)</span>
              <span>€0.35</span>
            </div>
          ...
          <div class="space-y-6">
            <div>
              ...
              <div class="space-y-3 text-gray-600">
                <p>📞 <a href="tel:+31201234567" class="hover:text-green-600">+31 20 123 4567</a></p>
                <p>✉️ <a href="mailto:info@groentaxi.nl" class="hover:text-green-600">info@groentaxi.nl</a></p>
              </div>
            </div>
            <div>
