        ...
        <div class="prose prose-lg max-w-none">
          ...
          <section class="mb-8">
            ...
            <p class="text-gray-700 leading-relaxed">
              {{ $t('privacyPolicy.dataCollectionContent') }}
            </p>
          </section>

          <section class="mb-8">
            <h2 class="text-2xl font-semibold text-gray-900 mb-4">
              {{ $t('privacyPolicy.purposeTitle') }}
            </h2>
          ...
          <div class="mt-12 pt-8 border-t border-gray-200">
            ...
            <div class="flex flex-col sm:flex-row gap-4">
              <a href="tel:+31681914785" class="inline-flex items-center text-green-600 hover:text-green-700 font-semibold">
                <Phone class="w-5 h-5 mr-2" />
                {{ $t('privacyPolicy.callUs') }} +31681914785
              </a>
              <a
                href="https://wa.me/31681914785"
                target="_blank"
...
useHead({
  ...
  meta: [
    {
      name: 'description',
      content: 'Privacy Policy for Huppie Taxi - Learn how we protect and handle your personal data.',
    },
  ],
});
</script>
