<template>
  <div>
    ...
    <a
      ...
      class="fixed bottom-4 right-4 z-50 bg-green-500 hover:bg-green-600 text-white rounded-full p-4 shadow-lg transition-all duration-300 hover:scale-110"
            ...
            <ul class="space-y-2 text-gray-400">
              ...
              <li class="flex items-center">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  class="flex items-center text-green-600 hover:text-green-700 font-semibold"
                >
